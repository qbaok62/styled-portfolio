...
export interface IButtonBackProps extends React.HTMLProps<HTMLButtonElement> {}

export interface IButtonFrontProps extends React.HTMLProps<HTMLButtonElement> {}
