...
export interface ICarouselMobileScrollNodeProps {
  final?: boolean;
}
...
export const CarouselMobileScrollNode = styled.div<ICarouselMobileScrollNodeProps>`
  @media ${(props) => props.theme.breakpoints.sm} {
    display: flex;
...
export const CarouselButton = styled.button<ICarouselButtonProps>`
